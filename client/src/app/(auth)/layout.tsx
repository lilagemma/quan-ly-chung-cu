  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="max-w-md">
            ...
            <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
              Quản lý chung cư của bạn
              <span className="text-blue-400"> một cách dễ dàng</span>
            </h2>
            <p className="text-slate-400 text-lg leading-relaxed">
              Thanh toán chi phí, theo dõi khiếu nại và kết nối với cộng đồng
              của bạn - tất cả chỉ trong một nơi.
            </p>

            {/* Features */}
            <div className="mt-12 space-y-4">
              {[
                "Thanh toán chi phí nhanh chóng",

                "Cảnh báo khẩn cấp theo thời gian thực",

                "Theo dõi và quản lý khiếu nại dễ dàng",
              ].map((feature, index) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* Auth Card Container */}
        <div className="sm:mx-auto sm:w-full sm:max-w-[440px]">{children}</div>
      </div>
    </div>
  );
}
