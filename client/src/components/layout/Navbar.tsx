            ...
            {user && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center gap-3 pl-2 pr-3 py-2 h-auto"
                  >
                  ...
                  <DropdownMenuLabel>
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-500 font-normal">
                        Căn hộ {user.flat_no} • {getRoleInfo(user.role).label}
                      </span>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
                ...
                {user && (
                  <div className="px-6 py-4">
                    ...
                    <Badge
                      variant="outline"
                      className={cn(
                        "mt-3 w-full justify-center py-1.5 font-medium",
                        getRoleInfo(user.role).color,
                      )}
                    >
                      {(() => {
